 ...
 * @typedef {{telepules: string, agazat: string, pelda: string, agazat2?: string, pelda2?: string}} RowspanType
...
const tbodyRenderRowspan = (tbody, element) => {
    const tr = document.createElement('tr');
    tbody.appendChild(tr);
    const td1 = createTableCell('td', element.telepules, tr)
    createTableCell('td', element.agazat, tr)
    createTableCell('td', element.pelda, tr)
    if(element.agazat2 && element.pelda2) {
        td1.rowSpan = 2;
        const tr2 = document.createElement('tr'); 
        tbody.appendChild(tr2);
        createTableCell('td', element.agazat2, tr2)
        createTableCell('td', element.pelda2, tr2)
    }
}
